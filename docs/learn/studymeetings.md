description: 国内で開催されている C++ 関連の勉強会イベントの紹介
...
## キャディ株式会社 C++ 勉強会
>[キャディ株式会社](https://corp.caddi.jp/)はテクニカルアドバイザーとして江添亮氏を迎え入れ、今後隔週でC++にまつわる勉強会を実施します。基礎的な内容から発展的な内容まで、幅広くシリーズ開催していく予定ですので、C++の勉強をしている方、江添亮氏やキャディメンバーとお話したい方など気軽にいらしてください。

- Twitter ハッシュタグ [#caddicpp](https://twitter.com/search?q=%23caddicpp)

| イベント番号                                                       | 内容             | ムービー                                   |
|-------------------------------------------------------------------|------------------|-------------------------------------------|
| #2 [(2019-08-21)](https://caddi.connpass.com/event/142476/)       | テンプレート基礎 | |
